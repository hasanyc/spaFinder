...
public class SearchBoxTestingUSA extends spafinder.com.base.USABaseClass {

	SearchBoxLocator sbl = new SearchBoxLocator ();
	SearchBoxValue sbv = new SearchBoxValue();
	
@Test ()
public void searchBySpa () throws IOException{
	driver.get(baseURL);
