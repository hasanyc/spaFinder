...
public class CABaseClass extends AbstractClass {
...
public static void setBrowser () throws IOException {
			...
			driver = new EventFiringWebDriver (wd);		
			   ...
			   baseURL = "http://qa.spafinder.ca";
	   
			//  baseURL = "http://172.16.100.245";       // Web 14
			
			//  baseURL = "http://172.16.100.146";      // Web 15
			 
			// baseURL = "http://172.16.100.170"; 		// Web 16
